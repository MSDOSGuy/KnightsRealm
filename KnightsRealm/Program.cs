...
// ##============={ DYNATEC COMPUTING STUDIOS }=============##
// THIS IS THE INTELLECTUAL PROPERTY OF DYNATEC COMPUTING
// PLEASE DO NOT REDISTRIBUTE THIS CODE IT IS COPYRIGHTED
// I ALLOW REUSE OF "MOST" OF MY ASSETS ( I ALLOW FULL REDISTRUBTION OF MY TEXTURES AS LONG AS NONE OF 
// THEM SIGNIFY DYNATEC COMPUTING ( company banners, logos etc...) ), PLEASE SEE MY WEBSITE DYNATECCOMPUTING.COM
// FOR FURTHER INFORMATION REGARDING GAINING PERMISSION TO USE VARIOUS
// TECHNIQUES FOUND IN THE CODE OR ASSETS OR ANYTHING THAT IS MADE BY ME. FOR THE MOST PART, I DO NOT ALLOW REDISTRUBTION OF ANY 
// ELEMENTS OF MY CODE WITHOUT CONTACTING ME PERSONALLY, AND EVEN THEN, I CAN'T GUARENTEE IT. ALTHOUGH I AM PRETTY LENIANT. ALSO PLEASE
// DO NOT COMPILE THIS CODE FOR YOUR OWN USE. PLEASE BUY THE FULL GAME. YOU CAN FIND IT HERE! ( )
// I ALLOW THE SOURCE CODE TO BE PUBLICLY DISPLAYED FOR CRITIZIM, CRITIQUE SO I CAN MAKE BETTERMENTS TO MY CODE, AND ALSO SO OTHER INDIVIDUALS
// CAN LEARN FROM IT AND REVIEW IT AND POSSIBLY IMPLEMENT SOME ELEMENTS OF SUCH CODE, WITHIN THEIR RESPECTIVE PROGRAM WITH PROPER PERMISSION KINDLY!
// OTHERWISE, YOU CAN EMAIL ME @ DYNATECCOMPUTING@GMAIL.COM REGARDING QUESTIONS OR CONCERNS ETC...
